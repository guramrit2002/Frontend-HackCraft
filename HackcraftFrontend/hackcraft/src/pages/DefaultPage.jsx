...
const RenderComponent = ({ data }) => {
    ...
    children?.map((child) => {
        switch (child.type) {
            case 'text':
                return (
                    <p key={child.id} style={child.style}>
                        {child.content}
                    </p>
                );
            case 'link':
                return (
                    <a href="#" key={child.id} style={child.style}>
                        {child.content}
                    </a>
                );
            case 'button':
                return (
                    <button key={child.id} style={child.style}>
                        {child.content}
                    </button>
                );
            case 'section':
    ...
    return <>{data.map((item) => renderSection(item))}</>;
};
...
const DefaultPage = () => {
    ...
    return <RenderComponent data={defaultPage} />;
};
